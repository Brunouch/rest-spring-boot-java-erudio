...
import bruno.spring.java.util.MediaType;
...
@Tag(name = "People", description = "Endpoints for Managin People")
public class PersonController {
	...
	@Operation(summary = "Add a new person", description = "Add a new person", tags = {"People"},
